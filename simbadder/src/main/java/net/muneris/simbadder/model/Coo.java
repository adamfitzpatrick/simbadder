...
/**
 * Data model for the complete COO data set provided by SIMBAD. Note that much
 * of the members of the COO data are duplicated in other SIMBAD data sets, so
 * this class extends the {@link CoordinateBaseObject} and only provides
 * wavelengthType information to complete the set.
 *
