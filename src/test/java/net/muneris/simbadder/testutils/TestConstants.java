...
public class TestConstants {
    ...
    public static final ResponseEntity<String> RESPONSEENTITY = new ResponseEntity<>(STRING,
            HttpStatus.ACCEPTED);
    public static final MockClientHttpResponse CLIENTHTTPRESPONSE = new MockClientHttpResponse(
            BYTES, HttpStatus.ACCEPTED);
    public static final String SIMBAD_PARSE_ERROR =
            "::error::::\n\n[3] java.text.ParseException: error message: " + "foo\n\nextra text";
