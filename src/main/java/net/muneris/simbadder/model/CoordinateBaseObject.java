...
public class CoordinateBaseObject {
     ...
     * the celestial equator, which occupies the same plane as the earth's
     * equator. Although declination is sometimes described in deg:mm:ss, at
     * this time the value is only available as a double.
     *
     ...
     * the celestial equator, which occupies the same plane as the earth's
     * equator. Although declination is sometimes described in deg:mm:ss, at
     * this time the value can only be set with a decimal representation.
     *
     * @param declination
     *            String representation of double in range [-90,90] degrees
     */
     ...
     *            String representation of double in range [0,24) hours
     */
